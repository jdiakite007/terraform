Dans Terraform, vous pouvez simplement utiliser le mot-clé variable pour déclaérer et définir une valeur qui sera injecter dans le code lors de son execution
